      ...
      <div className="p-4 border-b border-slate-100 flex items-center gap-3 bg-slate-50/80">
        ...
        <div>
          <div className="flex items-center gap-2">
            <h2 className="font-bold text-slate-900 text-sm">Assistente di {FREELANCER_PROFILE.name}</h2>
          </div>
            ...
            >
              ...
              <div className="max-w-[92%] sm:max-w-[85%] space-y-2.5">
                ...
                >
                  ...
                  <div className={`text-[10px] mt-1.5 text-right ${isBot ? 'text-slate-400' : 'text-indigo-200'}`}>
                    {msg.timestamp}
                  </div>
                </div>
